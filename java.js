...
function sendToTelegram(message) {
  const token = "6838826115:AAFPkZQNoUWicoYP2foTxPuHjC9pYokF_CM"; // Token bot Telegram Anda
  const chatId = "6978151784"; // Chat ID atau ID grup Anda
...
document.querySelectorAll(".h2").forEach((item) => {
  item.textContent = item.textContent.replace("RM1000", "BERJAYA RM450");
});
